...
// };
  ...
  // ---- Add this snippet (dev-only) ----
// test-dashboard (dev) — renders userDashboard.ejs with sample data (no auth)
app.get('/test-dashboard', (req, res) => {
  const sampleUser = { id: 'u_demo', username: 'varun', email: 'varun@example.com', role: 'user' };
  const sampleBookings = [
    {
      id: 'b1',
      user_id: 'u_demo',
      user_email: 'varun@example.com',
      user_name: 'varun',
      car_id: 'c1',
      car_name: 'Honda City',
